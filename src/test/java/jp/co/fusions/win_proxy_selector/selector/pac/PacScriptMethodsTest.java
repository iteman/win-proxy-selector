...
public class PacScriptMethodsTest {
	...
	public void testDnsDomainIs() {
		...
		// Added by K.Sugimoto
		assertEquals(true, buildParser().dnsDomainIs("www.mozilla.org", ".mozilla.org"));
		assertEquals(false, buildParser().dnsDomainIs("www", ".mozilla.org"));
	}
	...
	public void testDnsResolve() throws UnknownHostException {
		...
		//　Added by Kei Sugimoto
		assertEquals("127.0.0.1", buildParser().dnsResolve("localhost"));
	}
	...
	public void testIsInNet() {
		...
		// Added by K. Sugimoto
		assertEquals(true, buildParser().isInNet("192.168.0.122", "192.0.0.0", "255.0.0.0"));
		assertEquals(true, buildParser().isInNet("localhost", "127.0.0.1", "255.255.255.255"));
	}
	...
	public void testIsResolvable() throws UnknownHostException {
		...
		//Added by K. Sugimoto
		assertEquals(false, buildParser().isResolvable("x.x.x.x.x.x.x"));
	}
	...
	public void testLocalHostOrDomainIs() {
		...
		// Added by K. Sugimoto
		assertEquals(true, buildParser().localHostOrDomainIs("www.mozilla.org", "www.mozilla.org"));
		assertEquals(true, buildParser().localHostOrDomainIs("www", "www.mozilla.org"));
		assertEquals(false, buildParser().localHostOrDomainIs("www.google.com", "www.mozilla.org"));
		assertEquals(false, buildParser().localHostOrDomainIs("home.mozilla.org", "www.mozilla.org"));
	}
